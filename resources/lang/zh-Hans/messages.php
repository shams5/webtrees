...
return array (
  ...
  'PedigreeAdopted' => '过继',
  'Adopted by both parents' => '由养父母收养',
  ...
  'There is no user account with the email “%s”.' => '没有用户帐户的电子邮件是“%s”。',
  ...
  'This is the list of GEDCOM facts that your users can add to sources. You can modify this list by removing or adding fact names, even custom ones, as necessary. Fact names that appear in this list must not also appear in the “Unique source facts” list.' => '用户可以添加到来源中的GEDCOM事件清单。你可以通过删除或添加此清单上的事件名称，甚至可以自定义。在这个清单中的事件，不能同时出现在来源事件<i>唯一事件</i> 列表。',
  ...
  'This option controls whether or not to automatically display content of a <i>Source</i> record on the Individual page.' => '这个选项控制是否在个人页面自动显示<i>来源</i>的内容。',

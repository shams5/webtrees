...
return array (
  ...
  'Some genelealogy applications store all names in a single name record, using custom tags such as _MARNM and _AKA. An alternative is to create a new name record for each name.' => 'Some genelealogy applications store all names in a single name record, using custom tags such as _MARNM and _AKA. An alternative is to create a new name record for each name.',
  ...
  'There is no user account with the email “%s”.' => 'There is no user account with the e-mail ‘%s’.',
